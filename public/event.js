      ...
      return (function (g, h, i, j) {
        ...
        (function () {
          ...
          function B(a) {
            ...
            f || (a.customData = {});
            if (d.isInTest(x)) {
              a.customData.rex = { ex: "t", sx: e, retry: 0, failed: [] };
              if (e) {
                f = A(a);
                o(f, a.customData, t.ENDPOINT);
                b.trigger("XHR", f, a.customData);
                return;
              }
            } else d.isInControl(x) && (a.customData.rex = { ex: "c", sx: e, retry: 0, failed: [] });
            f = a.customData;
            e = a.eventName;
            var g = A(a);
            c.trigger(a.id, g);
      ...
      return (function (f, g, j, k) {
        ...
        (function () {
          ...
          function u(a) {
            ...
            if (r) for (var c = 0; c < t; c++) q.call(a, s[c]) && b.push(s[c]);
            return b;
          }
          function v(a, b) {
        ...
        (function () {
          ...
          function sa(a, b, c, d) {
            ...
            try {
              ...
              g.em != null &&
                Z(g.em) &&
                ((l = Z(g.em)), l === 1 && (i.em = ga));
              h.em != null &&
                Z(h.em) &&
                ((l = Z(h.em)), l === 1 && (k.em = ga));
            ...
            e.append("coo", g);
            i = U.pluginConfig.getWithGlobalFallback(
              a ? a.id : null,
              "dataProcessingOptions"
            );
            if (i != null) {
