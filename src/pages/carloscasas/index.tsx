    ...
    <>
      <section>
        <div className="grid items-center gap-4 mt-12 text-center md:grid-cols-2">
          ...
          <div className="hidden py-12 from-experto1 via-white to-white md:block md:bg-gradient-to-l">
            <StaticImage
              className="mx-auto"
      ...
      <section className="py-8 text-white bg-experto1">
          ...
          <div className="grid gap-4 mx-12 place-items-start sm:place-items-center md:mx-4 md:grid-cols-2">
            <div className="flex items-center justify-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-secondary">29 de Septiembre</p>
              </div>
            </div>
            <div>
              <div className="flex items-center justify-center gap-4">
      ...
      <div className="py-8 my-16 bg-gradient-to-r from-experto1 to-white" />
